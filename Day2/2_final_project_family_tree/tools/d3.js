...
!(function (t, n) {
            ...
            return (function (t) {
                ...
                return (e, r, i, o, a) => {
                    ...
                    for (let t = i, f = o; t <= f; t += a)
                        (u += r[Math.min(o, t + c)]), (e[t] = u / n), (u -= r[Math.max(i, t - c)]);
                };
            })(t);
        const e = t - n,
            r = 2 * t + 1;
    ...
    function x(t, n) {
        ...
        if (void 0 === n)
            ...
            let a = -1;
            for (let u of t)
                null != (u = n(u, ++a, t)) && (u = +u) >= u && ((e = u - i), (i += e / ++r), (o += e * (u - i)));
        }
        if (r > 1) return o / (r - 1);
    }
    function w(t, n) {
    ...
    function M(t, n) {
        ...
        if (void 0 === n)
            for (const n of t)
                null != n && (void 0 === e ? n >= n && (e = r = n) : (e > n && (e = n), r < n && (r = n)));
        else {
            let i = -1;
            for (let o of t)
                null != (o = n(o, ++i, t)) &&
            ...
            if (!Array.isArray(d)) {
                ...
                if (
                    ...
                    if (t >= h && n === M) {
                        const t = V(l, h, e);
                        isFinite(t) &&
                            (t > 0 ? (h = (Math.floor(h / t) + 1) * t) : t < 0 && (h = (Math.ceil(h * -t) + 1) / -t));
                    } else d.pop();
            }
        ...
        return (
            ...
            (r.thresholds = function (t) {
                return arguments.length
                    ? ((e = "function" == typeof t ? t : Y(Array.isArray(t) ? B.call(t) : t)), r)
                    : e;
            }),
            r
        );
    ...
    function rn(t, n, e, r, i, o, a) {
        ...
        for (u = 0; u < h; ++u)
            (f = a.call(t, o[u], u, o) + ""),
                (c = s.get(f)) ? ((r[u] = c), (c.__data__ = o[u]), s.delete(f)) : (e[u] = new nn(t, o[u]));
    ...
    Vn.prototype = Wn.prototype = {
        ...
        attr: function (t, n) {
            ...
            return this.each(
                (null == n ? (e.local ? fn : cn) : "function" == typeof n ? (e.local ? dn : hn) : e.local ? ln : sn)(
                    e,
                    n
                )
            );
        ...
        style: function (t, n, e) {
            return arguments.length > 1
                ? this.each((null == n ? gn : "function" == typeof n ? vn : yn)(t, n, null == e ? "" : e))
                : _n(this.node(), t);
        },
    ...
    function ne(t, n) {
        if (((t = te(t)), void 0 === n && (n = t.currentTarget), n)) {
            ...
            if (e.createSVGPoint) {
                ...
                return (
                    (r.x = t.clientX), (r.y = t.clientY), [(r = r.matrixTransform(n.getScreenCTM().inverse())).x, r.y]
                );
            }
                ...
                ? ((e = n[1].length),
                  ...
                  6 === e
                      ...
                      : 3 === e
                        ...
                        : 8 === e
                          ? De((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
                          : 4 === e
                            ? De(
                                  ((n >> 12) & 15) | ((n >> 8) & 240),
                                  ((n >> 8) & 15) | ((n >> 4) & 240),
    ...
    pe(ye, ze, {
        ...
        pe(
            ...
            ge(ye, {
                brighter(t) {
                    return (
                        (t = null == t ? _e : Math.pow(_e, t)), new qe(this.r * t, this.g * t, this.b * t, this.opacity)
                    );
                },
                darker(t) {
                    return (
                        (t = null == t ? ve : Math.pow(ve, t)), new qe(this.r * t, this.g * t, this.b * t, this.opacity)
                    );
                },
                rgb() {
                    return this;
    ...
    pe(
        ...
        ge(ye, {
            ...
            rgb() {
                ...
                return new qe(
                    sr(3.1338561 * (n = Qe * fr(n)) - 1.6168667 * (t = Je * fr(t)) - 0.4906146 * (e = tr * fr(e))),
                ...
                (function () {
                    ...
                    for (; e; )
                        e._call
                            ...
                            : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (pi = n)));
                    (gi = t), zi(r);
                })(),
                (xi = 0);
        }
    ...
    function zi(t) {
        yi ||
            ...
            t - xi > 24
                ? (t < 1 / 0 && (vi = setTimeout(Ci, t - Mi.now() - wi)), _i && (_i = clearInterval(_i)))
                : (_i || ((mi = Mi.now()), (_i = setInterval(Pi, bi))), (yi = 1), Ti(Ci)));
    }
    function $i(t, n, e) {
        var r = new Ei();
        return (
    ...
    Ei.prototype = Ni.prototype = {
        ...
        restart: function (t, n, e) {
            ...
            (e = (null == e ? Ai() : +e) + (null == n ? 0 : +n)),
                this._next || gi === this || (gi ? (gi._next = this) : (pi = this), (gi = this)),
                (this._call = t),
                (this._time = e),
                zi();
        },
        ...
        !(function (t, n, e) {
            ...
            function a(o) {
                ...
                if (
                    ...
                    for (e.state = Ii, r = new Array((l = e.tween.length)), f = 0, s = -1; f < l; ++f)
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
                for (var u, c, f = r[a], s = f.length, l = (o[a] = new Array(s)), h = 0; h < s; ++h)
                    (u = f[h]) &&
                        ...
                        ("__data__" in u && (c.__data__ = u.__data__), (l[h] = c), Li(l[h], n, e, h, l, Xi(u, e)));
                        ...
                        (function (t, n, e) {
                            ...
                            return function () {
                                var a = _n(this, t),
                                    ...
                                    c = u + "";
                                return (
                                    null == u && (this.style.removeProperty(t), (c = u = _n(this, t))),
        ...
        easeVarying: function (t) {
            ...
            return new Promise(function (o, a) {
                ...
                e.each(function () {
                    var e = Hi(this, r),
                        i = e.on;
                    i !== t && ((n = (t = i).copy())._.cancel.push(u), n._.interrupt.push(u), n._.end.push(c)),
                        (e.on = n);
                }),
                    0 === i && o();
            });
    ...
    var Oo = 1.70158,
        ...
        Go = (function t(n, e) {
            ...
            function i(t) {
                return (
                    ((t = 2 * t - 1) < 0 ? n * So(-t) * Math.sin((r - t) / e) : 2 - n * So(t) * Math.sin((r + t) / e)) /
                    2
                );
            }
            return (
    ...
    var fa = {
        ...
        ga = { overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1 },
        ya = { overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1 };
    function va(t) {
        return { type: t };
    }
    function _a(t) {
    ...
    function wa(t) {
        ...
        function h(e) {
            ...
            function I(t) {
                ...
                switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
                    ...
                    case ea:
                        $[1]
                            ? (x && ((a = oa(S, aa(N, $[0][0]))), (h = oa(S, aa(N, $[1][0]))), (x = 1)),
                              w && ((c = oa(E, aa(k, $[0][1]))), (p = oa(E, aa(k, $[1][1]))), (w = 1)))
                            : (x < 0
                                  ? ((C = oa(S - i, aa(N - i, C))), (a = i + C), (h = l))
                                  : x > 0 && ((C = oa(S - l, aa(N - l, C))), (a = i), (h = l + C)),
                              w < 0
                                  ? ((P = oa(E - u, aa(k - u, P))), (c = u + P), (p = d))
                                  : w > 0 && ((P = oa(E - d, aa(k - d, P))), (c = u), (p = d + P)));
                        break;
                    case ra:
                        x && ((a = oa(S, aa(N, i - C * x))), (h = oa(S, aa(N, l + C * x)))),
                            w && ((c = oa(E, aa(k, u - P * w))), (p = oa(E, aa(k, d + P * w))));
                }
                h < a &&
                    ((x *= -1),
                    (r = i),
        ...
        return (
            ...
            (l.prototype = {
                ...
                start: function (t, n) {
                    return (
                        this.starting ? ((this.starting = !1), this.emit("start", t, n)) : this.emit("brush", t), this
                    );
                },
                brush: function (t, n) {
            ...
            u = (d = ka(0, Na - e * c) / d) ? e : Na / c;
            {
                ...
                for (const e of s) {
                    ...
                    if (t) {
                        ...
                        i &&
                            t.sort((t, n) =>
                                i(t < 0 ? -a[~t * c + e] : a[e * c + t], n < 0 ? -a[~n * c + e] : a[e * c + n])
                            );
                        for (const r of t)
                            if (r < 0) {
                        ...
                        for (const r of t) {
                            ...
                            if (
                                (e < r
                                    ? ((t = l[e * c + r] || (l[e * c + r] = { source: null, target: null })),
                                      (t.source = {
                                          index: e,
                                          startAngle: n,
                                          endAngle: (n += a[e * c + r] * d),
                                    ...
                                    : ((t = l[r * c + e] || (l[r * c + e] = { source: null, target: null })),
                                      (t.target = {
                                          index: e,
                                          startAngle: n,
                                          endAngle: (n += a[e * c + r] * d),
    ...
    let Ua = class {
        ...
        arc(t, n, e, r, i, o) {
            ...
            null === this._x1
                ? this._append`M${c},${f}`
                : (Math.abs(this._x1 - c) > Ra || Math.abs(this._y1 - f) > Ra) && this._append`L${c},${f}`,
                e &&
                    (l < 0 && (l = (l % Da) + Da),
                    l > Fa
                        ? this
    ...
    function nu(t, n, e) {
        ...
        return (
            ...
            ((i = t[(r = +(t[0] === n[0]))]), (o = e[r]), (a = n[r]), (i <= o && o <= a) || (a <= o && o <= i))
        );
    }
    function eu() {}
    var ru = [
    ...
    function iu() {
        ...
        function o(e, i) {
            ...
            return (
                (function (e, r, i) {
                    ...
                    for (; ++u < n - 1; ) {
                        for (
                            o = -1, f = au(e[u * t + t], r), s = au(e[u * t], r), ru[(f << 1) | (s << 2)].forEach(p);
                            ++o < t - 1;
        ...
        return (
            ...
            (i.thresholds = function (t) {
                return arguments.length
                    ? ((e = "function" == typeof t ? t : Array.isArray(t) ? Qa(Za.call(t)) : Qa(t)), i)
                    : e;
            }),
            (i.smooth = function (t) {
    ...
    function pu(t, n, e, r, i) {
        ...
        if (l < t && h < e)
            for (
                ...
                s > f == s > -f
                    ? ((a = o + f), (c = a - o), (u = o - (a - c) + (f - c)), (f = n[++l]))
                    : ((a = o + s), (c = a - o), (u = o - (a - c) + (s - c)), (s = r[++h])),
                    (o = a),
                    0 !== u && (i[d++] = u);
        for (; l < t; )
        ...
        return Math.abs(c) >= 33306690738754716e-32 * f
            ...
            : -(function (t, n, e, r, i, o, a) {
                  ...
                  if (
                      ...
                      return k;
                  if (((C = vu * a + du * Math.abs(k)), (k += A * s + N * u - (E * f + S * c)), k >= C || -k >= C))
                      return k;
                  (m = u * N),
                      (h = hu * u),
                      (d = h - (h - u)),
    ...
    class Su {
        ...
        update() {
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                ...
                let _ = e[y];
                for (; (g = e[_]), Mu(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0; )
                    (v = this._addTriangle(_, c, g, r[c], -1, r[_])),
                        ...
                        (_ = g);
                if (y === l)
                    for (; (g = n[y]), Mu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0; )
        ...
        _legalize(t) {
            ...
            for (;;) {
                ...
                const c = a - (a % 3),
                    ...
                    p = n[s];
                if (
                    Nu(r[2 * l], r[2 * l + 1], r[2 * h], r[2 * h + 1], r[2 * d], r[2 * d + 1], r[2 * p], r[2 * p + 1])
                ) {
                    (n[t] = p), (n[a] = l);
                    const r = e[s];
                    if (-1 === r) {
    ...
    function Cu(t, n, e, r) {
        if (r - e <= 20)
            ...
            (t[e + 1] = t[o]),
                (t[o] = a),
                r - i + 1 >= o - e ? (Cu(t, n, i, r), Cu(t, n, e, o - 1)) : (Cu(t, n, e, o - 1), Cu(t, n, i, r));
        }
    }
    function Pu(t, n, e) {
        const r = t[n];
    ...
    class Ru {
        ...
        arc(t, n, e) {
            ...
            null === this._x1
                ? (this._ += `M${r},${i}`)
                : (Math.abs(this._x1 - r) > Du || Math.abs(this._y1 - i) > Du) && (this._ += "L" + r + "," + i),
        ...
        *cellPolygons() {
        ...
        _renderSegment(t, n, e, r, i) {
            ...
            0 === a && 0 === u
                ...
                : (o = this._clipSegment(t, n, e, r, a, u)) && (i.moveTo(o[0], o[1]), i.lineTo(o[2], o[3]));
        }
        contains(t, n, e) {
        ...
        *neighbors(t) {
        ...
        _clip(t) {
            ...
            return this._simplify(
                e[r] || e[r + 1] ? this._clipInfinite(t, n, e[r], e[r + 1], e[r + 2], e[r + 3]) : this._clipFinite(t, n)
            );
        }
        _clipFinite(t, n) {
            const e = n.length;
        ...
        _clipInfinite(t, n, e, r, i, o) {
            ...
            if (
                ...
                this.contains(t, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2) &&
                    (u = [this.xmin, this.ymin, this.xmax, this.ymin, this.xmax, this.ymax, this.xmin, this.ymax]);
            return u;
        }
        _edge(t, n, e, r, i) {
            for (; n !== e; ) {
            ...
            if (t && t.length > 4) {
                for (let n = 0; n < t.length; n += 2) {
                    const e = (n + 2) % t.length,
                        r = (n + 4) % t.length;
                    ((t[n] === t[e] && t[e] === t[r]) || (t[n + 1] === t[e + 1] && t[e + 1] === t[r + 1])) &&
                        (t.splice(e, 2), (n -= 2));
                }
                t.length || (t = null);
            }
        ...
        *neighbors(t) {
        ...
        _step(t, n, e) {
            ...
            do {
                ...
                if (((h = a[h]), -1 === h)) {
                    if (((h = i[(o[t] + 1) % i.length]), h !== r && Iu(n - c[2 * h], 2) + Iu(e - c[2 * h + 1], 2) < s))
                        return h;
                    break;
                }
            } while (h !== l);
    ...
    function Qu(t) {
        ...
        return isNaN(t)
            ? "Invalid Date"
            : ((n = t.getUTCFullYear()) < 0 ? "-" + Ku(-n, 6) : n > 9999 ? "+" + Ku(n, 6) : Ku(n, 4)) +
                  "-" +
                  Ku(t.getUTCMonth() + 1, 2) +
                  "-" +
                  Ku(t.getUTCDate(), 2) +
                  (o
                      ? "T" + Ku(e, 2) + ":" + Ku(r, 2) + ":" + Ku(i, 2) + "." + Ku(o, 3) + "Z"
                      : i
    ...
    (Fc.copy = function () {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
            for (var i = 0; i < 4; ++i)
                (n = r.source[i]) &&
                    (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Rc(n)));
        return e;
    }),
        (Fc.add = function (t) {
    ...
    var of,
        ...
        uf = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function cf(t) {
        var n,
            e,
            r =
        ...
        function l(t) {
            var n = (t = Jc(t)).fill,
                ...
                v = t.trim,
                _ = t.type;
            "n" === _ ? ((g = !0), (_ = "g")) : ef[_] || (void 0 === y && (y = 12), (v = !0), (_ = "g")),
                (d || ("0" === n && "=" === e)) && ((d = !0), (n = "0"), (e = "="));
        ...
        Fs = {
            ...
            polygonEnd: function () {
                cs.polygonEnd(),
                    ...
                    (Fs.lineStart = Is),
                    (Fs.lineEnd = Os),
                    as < 0 ? ((Wf = -(Kf = 180)), (Zf = -(Qf = 90))) : rs > df ? (Qf = 90) : rs < -df && (Zf = -90),
                    (os[0] = Wf),
                    (os[1] = Kf);
            },
            sphere: function () {
    ...
    function Qs(t, n) {
        ...
        var e = Tf((n *= mf)),
            ...
            o = Cf(n),
            a = Mf(
                zf((a = Ds * o - Rs * i) * a + (a = Rs * r - $s * o) * a + (a = $s * i - Ds * r) * a),
                $s * r + Ds * i + Rs * o
            );
        (xs += a),
            (As += a * ($s + ($s = r))),
    ...
    function hl(t, n, e, r, i, o) {
        if (e) {
            ...
            null == i
                ? ((i = n + r * _f), (o = n - c / 2))
                : ((i = dl(a, i)), (o = dl(a, o)), (r > 0 ? i < o : i > o) && (i += r * _f));
    ...
    function ml(t, n) {
        ...
        for (var f = 0, s = t.length; f < s; ++f)
            if ((h = (l = t[f]).length))
                for (
                    var l, h, d = l[h - 1], p = bl(d), g = d[1] / 2 + vf, y = Cf(g), v = Tf(g), _ = 0;
                    _ < h;
                    ++_, p = m, y = w, v = M, d = b
                ) {
                    var b = l[_],
                        ...
                        : i !== u &&
                          ...
                          (r = (function (t, n, e, r) {
                              var i,
                                  ...
                                  a = Cf(t - e);
                              return xf(a) > df
                                  ? wf((Cf(n) * (o = Tf(r)) * Cf(e) - Cf(r) * (i = Tf(n)) * Cf(t)) / (i * o * a))
                                  : (n + r) / 2;
                          })(e, r, o, a)),
                          t.point(i, r),
                          t.lineEnd(),
                    ...
                    point: function (l, h) {
                        ...
                        if (
                            ...
                            y & e ||
                                ...
                                ((s = 0),
                                r
                                    ? (t.lineStart(), t.point(v[0][0], v[0][1]), t.point(v[1][0], v[1][1]), t.lineEnd())
                                    : (t.point(v[1][0], v[1][1]),
                                      t.lineEnd(),
                                      t.lineStart(),
                    ...
                    polygonEnd: function () {
                        var n = (function () {
                                for (var n = 0, e = 0, i = f.length; e < i; ++e)
                                    for (
                                        var o, a, u = f[e], c = 1, s = u.length, l = u[0], h = l[0], d = l[1];
                                        c < s;
                                        ++c
                                    )
                                        (o = h),
    ...
    function Kl() {
        ...
        return (
            ...
            (v.precision = function (h) {
                return arguments.length
                    ? ((y = +h), (c = Wl(o, i, 90)), (f = Zl(n, t, y)), (s = Wl(u, a, 90)), (l = Zl(r, e, y)), v)
                    : y;
            }),
            v
                .extentMajor([
                  ...
                  function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                      ...
                      if (b > 4 * n && g--) {
                          var m = a + h,
                              ...
                              C = N - i,
                              P = _ * k - v * C;
                          ((P * P) / b > n || xf((v * k + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < hd) &&
            ...
            (E.clipExtent = function (t) {
                return arguments.length
                    ? ((A =
                          null == t
                              ? ((T = r = i = o = null), eh)
                              : zl((T = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
                      C())
                    : null == T
                      ? null
                      : [
        ...
        for (var e, r, i, o, a, u = new Qd(t), c = [u]; (e = c.pop()); )
            if ((i = n(e.data)) && (a = (i = Array.from(i)).length))
                for (e.children = i, o = a - 1; o >= 0; --o)
                    c.push((r = i[o] = new Qd(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
    ...
    (qd.invert = function (t, n) {
        for (
            ...
            ((o =
                (i =
                    (r -= e =
                        (r * (zd + $d * i + o * (Dd + Rd * i)) - n) / (zd + 3 * $d * i + o * (7 * Dd + 9 * Rd * i))) *
                    r) *
                i *
                i),
            !(xf(e) < pf));
        ...
        (Id.invert = function (t, n) {
            ...
            return [
                t / (0.8707 + (o = r * r) * (o * (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) - 0.131979)),
                r,
            ];
        }),
        (Od.invert = Md(Rf)),
    ...
    function bp(t, n) {
        ...
        t: for (c = 3; c < o; ++c) {
            ...
            for (i.previous = e, i.next = r, e.next = r.previous = r = i, a = vp(e); (i = i.next) !== r; )
                (u = vp(i)) < a && ((e = i), (a = u));
            r = e.next;
        }
    ...
    function Bp(t, n, e, r, i, o) {
        for (
            var a, u, c, f, s, l, h, d, p, g, y, v = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value;
            b < x;
            ...
            for (
                l = h = s, y = s * s * (g = Math.max(f / c, c / f) / (w * t)), p = Math.max(h / y, y / l);
                m < x;
                ++m
            ) {
                if (
        ...
        return (
            ...
            (e.tickFormat = (n, r) => {
                if (
                    ...
                    null == r && (r = 10 === a ? "s" : ","),
                    "function" != typeof r &&
                        (a % 1 || null != (r = Jc(r)).precision || (r.trim = !0), (r = t.format(r))),
                    n === 1 / 0)
                )
                    return r;
            ...
            (e.nice = () => r(kg(r(), { floor: (t) => o(Math.floor(i(t))), ceil: (t) => o(Math.ceil(i(t))) }))),
            e
        );
    }
    function qg(t) {
    ...
    function Vg(t, n, e, r) {
        ...
        return (
            ...
            e &&
                ((i.count = (n, r) => (Xg.setTime(+n), Gg.setTime(+r), t(Xg), t(Gg), Math.floor(e(Xg, Gg)))),
                (i.every = (t) => (
                    (t = Math.floor(t)),
                    isFinite(t) && t > 0
                        ? t > 1
    ...
    const Zg = Wg.range,
        ...
        py = Vg(
            ...
            (t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Qg) / ty,
            (t) => t.getDate() - 1
        ),
        gy = py.range,
        yy = Vg(
    ...
    function O_() {
        ...
        return (
            (f.domain = function (i) {
                return arguments.length
                    ? (([o, a] = i), (t = r((o = +o))), (n = r((a = +a))), (e = t === n ? 0 : 1 / (n - t)), f)
                    : [o, a];
            }),
            (f.clamp = function (t) {
    ...
    function L_() {
        ...
        function d(t) {
            return isNaN((t = +t))
                ? a
                : ((t = 0.5 + ((t = +o(t)) - n) * (s * t < s * n ? r : i)), l(h ? Math.max(0, Math.min(1, t)) : t));
        }
        function p(t) {
            return function (n) {
                var e, r, i;
                return arguments.length ? (([e, r, i] = n), (l = di(t, [e, r, i])), d) : [l(0), l(0.5), l(1)];
            };
        }
        return (
            (d.domain = function (a) {
    ...
    function rw(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (ew(o) + ew(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function iw(t, n) {
        var e = t._x1 - t._x0;
    ...
    (Tw.prototype = ww.prototype),
        ...
        (t.active = function (t, n) {
            ...
            if (i)
                for (r in ((n = null == n ? null : n + ""), i))
                    if ((e = i[r]).state > qi && e.name === n) return new po([[t]], Zo, n, +r);
            return null;
        }),
        (t.arc = function () {
            var t = Cm,
                ...
                if ((u || (u = f = c()), h < l && ((s = h), (h = l), (l = s)), h > Tm))
                    if (g > Em - Tm)
                        u.moveTo(h * bm(d), h * wm(d)),
                            u.arc(0, 0, h, d, p, !y),
                            l > Tm && (u.moveTo(l * bm(p), l * wm(p)), u.arc(0, 0, l, p, d, y));
                    else {
                        var v,
                            _,
                            b = d,
                        ...
                        if (S > Tm) {
                            var C = Nm((S / l) * wm(A)),
                                P = Nm((S / h) * wm(A));
                            (M -= 2 * C) > Tm ? ((x += C *= y ? 1 : -1), (w -= C)) : ((M = 0), (x = w = (d + p) / 2)),
                                (T -= 2 * P) > Tm
                                    ? ((b += P *= y ? 1 : -1), (m -= P))
                                    : ((T = 0), (b = m = (d + p) / 2));
                        }
                        ...
                        T > Tm
                            ? k > Tm
                                ? ((v = Rm(I, O, z, $, h, k, y)),
                                  ...
                                  k < E
                                      ? u.arc(v.cx, v.cy, k, _m(v.y01, v.x01), _m(_.y01, _.x01), !y)
                                      : (u.arc(v.cx, v.cy, k, _m(v.y01, v.x01), _m(v.y11, v.x11), !y),
                                        u.arc(
                                            0,
                                            0,
                                            h,
                                        ...
                                        u.arc(_.cx, _.cy, k, _m(_.y11, _.x11), _m(_.y01, _.x01), !y)))
                            ...
                            l > Tm && M > Tm
                                ? N > Tm
                                    ? ((v = Rm(D, R, q, U, l, -N, y)),
                                      ...
                                      N < E
                                          ? u.arc(v.cx, v.cy, N, _m(v.y01, v.x01), _m(_.y01, _.x01), !y)
                                          : (u.arc(v.cx, v.cy, N, _m(v.y01, v.x01), _m(v.y11, v.x11), !y),
                                            u.arc(
                                                0,
                                                0,
                                                l,
                                            ...
                                            u.arc(_.cx, _.cy, N, _m(_.y11, _.x11), _m(_.y01, _.x01), !y)))
                                    : u.arc(0, 0, l, w, x, y)
                                : u.lineTo(D, R);
                    }
                else u.moveTo(0, 0);
        ...
        (t.contourDensity = function () {
            ...
            return (
                ...
                (d.thresholds = function (t) {
                    return arguments.length
                        ? ((s = "function" == typeof t ? t : Array.isArray(t) ? Qa(Za.call(t)) : Qa(t)), d)
                        : s;
                }),
            ...
            function y(t, n) {
                if (i.call(this, t, n)) {
                    var e,
                        ...
                        c = a.length;
                    for (e = 0; e < c; ++e)
                        (r = b(this, u, t, n, a[e].identifier, a[e])) && (ie(t), r("start", t, a[e]));
                }
            }
            function v(t) {
                var n,
        ...
        (t.geoBounds = function (t) {
            ...
            if (((Qf = Kf = -(Wf = Zf = 1 / 0)), (is = []), Lf(t, Fs), (e = is.length))) {
                ...
                for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
                    (i = o[n]), (u = js(r[1], i[0])) > a && ((a = u), (Wf = i[0]), (Kf = r[1]));
            }
            return (
                (is = os = null),
                Wf === 1 / 0 || Zf === 1 / 0
        ...
        (t.geoCentroid = function (t) {
            ...
            var n = +Ns,
                ...
                i = Ef(n, e, r);
            return i < pf &&
                ((n = As), (e = Ss), (r = Es), xs < df && ((n = ws), (e = Ms), (r = Ts)), (i = Ef(n, e, r)) < pf)
                ? [NaN, NaN]
                : [Mf(e, n) * bf, Rf(r / i) * bf];
        }),
                ...
                (b.clipExtent = function (t) {
                    return arguments.length
                        ? ((v =
                              null == t
                                  ? ((d = e = r = i = null), eh)
                                  : zl((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))),
                          _())
                        : null == d
                          ? null
                          : [
        ...
        (t.geoPath = function (t, n) {
            ...
            function a(t) {
                return (
                    t && ("function" == typeof o && r.pointRadius(+o.apply(this, arguments)), Lf(t, e(r))), r.result()
                );
            }
            return (
                (a.area = function (t) {
            ...
            return (
                ...
                "rgb(" +
                    Math.max(
                        ...
                        Math.min(
                            255,
                            Math.round(-4.54 - t * (35.34 - t * (2381.73 - t * (6402.7 - t * (7024.72 - 2710.57 * t)))))
                        )
                    ) +
                    ", " +
                    Math.max(
                        ...
                        Math.min(
                            255,
                            Math.round(32.49 + t * (170.73 + t * (52.82 - t * (131.46 - t * (176.58 - 67.37 * t)))))
                        )
                    ) +
                    ", " +
                    Math.max(
                        ...
                        Math.min(
                            255,
                            Math.round(
                                81.24 + t * (442.36 - t * (2482.43 - t * (6167.24 - t * (6614.94 - 2475.67 * t))))
                            )
                        )
                    ) +
                    ")"
        ...
        (t.interpolateRainbow = function (t) {
            ...
            return (um.h = 360 * t - 100), (um.s = 1.5 - 1.5 * n), (um.l = 0.8 - 0.9 * n), um + "";
        }),
                ...
                "rgb(" +
                    Math.max(
                        ...
                        Math.min(
                            255,
                            Math.round(
                                34.61 + t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49 - 14825.05 * t))))
                            )
                        )
                    ) +
                    ", " +
                    Math.max(
                        ...
                        Math.min(
                            255,
                            Math.round(
                                23.31 + t * (557.33 + t * (1225.33 - t * (3574.96 - t * (1073.77 + 707.56 * t))))
                            )
                        )
                    ) +
                    ", " +
                    Math.max(
                        ...
                        Math.min(
                            255,
                            Math.round(
                                27.2 + t * (3211.1 - t * (15327.97 - t * (27814 - t * (22569.18 - 6838.66 * t))))
                            )
                        )
                    ) +
                    ")"
        ...
        (t.pie = function () {
            ...
            function a(a) {
                ...
                for (
                    ...
                    (c = p[u]),
                        (s = y + ((l = g[c]) > 0 ? l * f : 0) + b),
                        (g[c] = { data: a[c], index: u, value: l, startAngle: y, endAngle: s, padAngle: _ });
                return g;
            }
            return (
                (a.value = function (n) {
        ...
        (t.pointers = function (t, n) {
            return (
                t.target && ((t = te(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
        ...
        (t.polygonContains = function (t, n) {
            for (
                var e, r, i = t.length, o = t[i - 1], a = n[0], u = n[1], c = o[0], f = o[1], s = !1, l = 0;
                l < i;
                ++l
            )
                (e = (o = t[l])[0]),
        ...
        (t.rank = function (t, e = n) {
            ...
            let a, u;
            return (
                (t = Uint32Array.from(r, (t, n) => n)).sort(e === n ? (t, n) => O(r[t], r[n]) : I(o)),
                t.forEach((t, n) => {
        ...
        (t.scaleTime = function () {
            return hg.apply(
                I_(uv, cv, tv, Zy, xy, py, sy, ay, iy, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
                arguments
            );
        }),
        (t.scaleUtc = function () {
            return hg.apply(
                I_(ov, av, ev, Qy, Fy, yy, hy, cy, iy, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
                arguments
            );
        }),
        (t.scan = function (t, n) {
        ...
        (t.stack = function () {
            ...
            return (
                ...
                (i.order = function (t) {
                    return arguments.length
                        ? ((n = null == t ? dw : "function" == typeof t ? t : ym(Array.from(t))), i)
                        : n;
                }),
                (i.offset = function (t) {
        ...
        (t.stratify = function () {
            ...
            function r(r) {
                ...
                for (a = 0, i = h.length; a < i; ++a)
                    (o = h[a]),
                        (f = h[a] = new Qd(o)),
                        null != (s = d(o, a, r)) && (s += "") && ((l = f.id = s), g.set(l, g.has(l) ? Ep : f)),
        ...
        (t.zoom = function () {
                        ...
                        u = Zn(t.view)
                            .on(
                                ...
                                function (t) {
                                    ...
                                    a.event(t).zoom(
                                        "mouse",
                                        o(b(a.that.__zoom, (a.mouse[0] = ne(t, i)), a.mouse[1]), a.extent, f)
                                    );
                                },
                                !0
                            )
            ...
            return (
                ...
                (v.translateExtent = function (t) {
                    return arguments.length
                        ? ((f[0][0] = +t[0][0]), (f[1][0] = +t[1][0]), (f[0][1] = +t[0][1]), (f[1][1] = +t[1][1]), v)
                        : [
                              [f[0][0], f[0][1]],
                              [f[1][0], f[1][1]],
                          ];
